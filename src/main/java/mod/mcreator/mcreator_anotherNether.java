...
public class mcreator_anotherNether {
	...
	public static int DIMID      = mcreator_VarListtestenvironmentmod.ANetherDimID;
     public static int SeedOffset = mcreator_VarListtestenvironmentmod.ANetherSeedOffset;
	...
	static {
		...
		portal = (BlockTutorialPortal) (new BlockTutorialPortal().setBlockName("anotherNether_portal").setBlockTextureName("glass_magenta"));
		Block.blockRegistry.addObject(183, "anotherNether_portal", portal);
		block = (ModTrigger) (new ModTrigger().setUnlocalizedName("anotherNether_trigger").setTextureName("flint_and_steel"));
		Item.itemRegistry.addObject(430, "anotherNether_trigger", block);
	}

	public mcreator_anotherNether() {
	}

	public void load() {
          DIMID      = ConfigHandler.getInt("dim_id", "Nether");
          SeedOffset = ConfigHandler.getInt("seed_offset", "Nether");
          if (DIMID==0){
               DIMID = mcreator_VarListtestenvironmentmod.ANetherDimID;
          }
		GameRegistry.registerBlock(portal, "anotherNether_portal");
		DimensionManager.registerProviderType(DIMID, mcreator_anotherNether.WorldProviderMod.class, false);
		DimensionManager.registerDimension(DIMID, DIMID);
          ConfigHandler.writeConfig("dim_id", "Nether", DIMID);
          ConfigHandler.writeConfig("seed_offset", "Nether", SeedOffset);

		GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{"XXX", "X45", "X78", Character.valueOf('4'),
				new ItemStack(Items.flint_and_steel, 1), Character.valueOf('5'), new ItemStack(Blocks.netherrack, 1), Character.valueOf('7'),
				new ItemStack(Blocks.netherrack, 1), Character.valueOf('8'), new ItemStack(Blocks.netherrack, 1),});
	...
	public static class WorldProviderMod extends WorldProviderHell {
		...
		public Vec3 getFogColor(float par1, float par2) {
			return Vec3.createVectorHelper(0.6D, 0.0D, 0.0D);
		}

		public IChunkProvider createChunkGenerator() {
			return new ChunkProviderHell(this.worldObj, this.worldObj.getSeed()+SeedOffset);
		}
				...
				for (i3 = -1; i3 <= 1; ++i3) {
					for (j3 = 1; j3 < 3; ++j3) {
						for (k3 = -1; k3 < 3; ++k3) {
							...
							j4 = k2 + (j3 - 1) * l2 - i3 * l5;
							flag = k3 < 0;
							this.worldServerInstance.setBlock(l3, i4, j4, flag ? Blocks.soul_sand : Blocks.air);
						}
					}
				}
			}
			...
			for (i3 = 0; i3 < 4; ++i3) {
				for (j3 = 0; j3 < 4; ++j3) {
					for (k3 = -1; k3 < 4; ++k3) {
						...
						this.worldServerInstance.setBlock(l3, i4, j4, (Block) (flag ? Blocks.soul_sand : portal), 0, 2);
					}
				}
	...
	public static class BlockTutorialPortal extends BlockBreakable {
		...
		public void registerBlockIcons(IIconRegister reg) {
			this.gor = reg.registerIcon("glass_magenta");
			this.dol = reg.registerIcon("glass_magenta");
			this.st1 = reg.registerIcon("glass_magenta");
			this.st2 = reg.registerIcon("glass_magenta");
			this.st3 = reg.registerIcon("glass_magenta");
			this.st4 = reg.registerIcon("glass_magenta");
		}
		...
		public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4) {
			byte b0 = 0;
			byte b1 = 0;
			if (par1World.getBlock(par2 - 1, par3, par4) == Blocks.soul_sand || par1World.getBlock(par2 + 1, par3, par4) == Blocks.soul_sand) {
				b0 = 1;
			}
			if (par1World.getBlock(par2, par3, par4 - 1) == Blocks.soul_sand || par1World.getBlock(par2, par3, par4 + 1) == Blocks.soul_sand) {
				b1 = 1;
			}
			if (b0 == b1) {
				return false;
		...
		public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, Block par5) {
			...
			if (par1World.getBlock(par2, i1 - 1, par4) != Blocks.soul_sand) {
				...
				if (j1 == 3 && par1World.getBlock(par2, i1 + j1, par4) == Blocks.soul_sand) {
					boolean flag = par1World.getBlock(par2 - 1, par3, par4) == this || par1World.getBlock(par2 + 1, par3, par4) == this;
					boolean flag1 = par1World.getBlock(par2, par3, par4 - 1) == this || par1World.getBlock(par2, par3, par4 + 1) == this;
					if (flag && flag1) {
						par1World.setBlockToAir(par2, par3, par4);
					} else {
						if ((par1World.getBlock(par2 + b0, par3, par4 + b1) != Blocks.soul_sand || par1World.getBlock(par2 - b0, par3, par4 - b1) != this)
								&& (par1World.getBlock(par2 - b0, par3, par4 - b1) != Blocks.soul_sand || par1World.getBlock(par2 + b0, par3, par4
										+ b1) != this)) {
							par1World.setBlockToAir(par2, par3, par4);
						}
					}
	...
	public static class GenLayerBiomes extends GenLayer {
		...
		protected BiomeGenBase[] allowedBiomes = {BiomeGenBase.hell,};
